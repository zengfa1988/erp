...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    loginName:{validator:function(value){
    		return /^[0-9a-zA-Z][\_0-9a-zA-Z|0-9a-zA-Z]{1,19}$/.test(value)
           // var len=$.trim(value).length;
              //  return len>=2&&len<=20;
            },
                message:"请输入有效的账号！"
    ...
    userPwd : {// 密码验证
    	validator : function(value) {
    		return /^[0-9a-zA-Z]{6,15}$/i.test(value)
        },
        message : '密码为6-16个字符，不支持空格'
    },
    newPwd : {// 新密码验证
        	validator : function(value) {
            	var pwd=['123456','234567','345678','456789','987654','876543','765432','654321'];
    			return /^[0-9a-zA-Z]{6,15}$/i.test(value)&&!/^([0-9a-zA-Z])\1{5}$/.test(value)&&$.inArray(value, pwd )<0;
    			///^(.)\1+$/
            },
        message : '密码为6-16个字符，不支持空格(不能使用有规律的密码，如123456,888888)'
    },
    faxno : {// 验证传真
        validator : function(value) {
