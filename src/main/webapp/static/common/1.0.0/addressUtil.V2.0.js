...
addressUtil = {
	addressApiUrl: "http://qr.yuanlianzhifu.com",
	//初始化地址控件
	/***
    ...
    initAddress: function(provinceId, cityId, countyId, townId, addressObj) {
		 addressUtil.areaURL = this.addressApiUrl+"/addr/list.do?pid=";
    ...
    initProvince: function(param_provinceId,param_cityId,param_countyId,param_townId) {
        ...
        var url = addressUtil.areaURL + 0 +"&level=0";
        /* 异步请求加载数据 */
        $.ajax({
            type: 'get',
//            dataType: "jsonp",
//            jsonp: "callback",
    ...
    initCity: function(values, flag, param_cityId, param_countyId, param_townId) {
        ...
        if (values != -1 && values != null && flag == 1) {
            var url = addressUtil.areaURL + values + "&level=1";
            /* 异步请求加载数据 */
            $.ajax({
                type: 'get',
//                dataType: "jsonp",
    ...
    initCounty:function(values, flag,param_countyId, param_townId) {
        ...
        if (values != -1 && values != null && flag == 1) {
            var url = addressUtil.areaURL + values + "&level=2";
            /* 异步请求加载数据 */
            $.ajax({
                type: 'get',
//                dataType: "jsonp",
